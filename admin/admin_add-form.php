...
<div id="popup">
  <form id="form">
    ...
    <br>
    <input id="stepIndex_popup" name="stepIndex_popup" type="hidden" value=""/>
    <p1>Heading</p1>
    <br>
  ...
  <div id="">
    ...
    if(isset($_GET['id']) && $_GET['action'] = 'edit') {
      ...
      foreach ($formfiels as $fields) {
        ...
        echo '<div class="fieldset-group"><p1>Heading</p1>
...
<div class="form-submit"><button type="submit" id="updateForm" name="updateForm">Update</button></div>';
      } else {
     ?>
